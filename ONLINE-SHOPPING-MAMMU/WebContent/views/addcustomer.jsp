...
<div class="inputbox">
	Enter Customer Id- <input type="text" name="cid"  placeholder="" required="required">
 Enter Customer Password-<input type="text" name="cpass"  placeholder="" required="required">
  Enter Customer balance-<input type="text" name="balance"  placeholder="" required="required">
